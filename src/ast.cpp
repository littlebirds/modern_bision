...
namespace ast {
    ...
    void IntLitExpr::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    void FloatLitExpr::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    void StringLitExpr::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    void UnaryExpr::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    void BinOpExpr::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    void ArrayExpr::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    void LetExpr::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    void ExprSeq::accept(ASTVisitor& visitor) { visitor.visit(*this); }
    ...
    void StmtList::accept(ASTVisitor& visitor) { visitor.visit(*this); }
