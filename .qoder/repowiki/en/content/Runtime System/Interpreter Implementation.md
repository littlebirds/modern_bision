...
- [grammar.y:1-130](file://grammar.y#L1-L130)
...
**Section sources**
- [interpreter.hpp:10-43](file://include/interpreter.hpp#L10-L43)
- [interpreter.cpp:8-244](file://src/interpreter.cpp#L8-L244)
- [value.hpp:25-94](file://include/value.hpp#L25-L94)
...
- [context.hpp:10-39](file://include/context.hpp#L10-L39)
- [value.hpp:25-171](file://include/value.hpp#L25-L171)
...
**Section sources**
- [interpreter.cpp:15-244](file://src/interpreter.cpp#L15-L244)
...
**Diagram sources**
- [ast.hpp:14-201](file://include/ast.hpp#L14-L201)
...
- [interpreter.cpp:205-209](file://src/interpreter.cpp#L205-L209)
...
The implementation provides an excellent foundation for extending the language with additional features such as array indexing, function calls, and advanced type checking capabilities as outlined in the project roadmap.